...
export default function PostPage({ postData }) {
    ...
    const deleteDataRow = (e) => {
        e.preventDefault();
        destroy(route('post.destroy', dataEdit.id), {
            preserveScroll: true,
                    ...
                    <div className="col-md-12">
                        <div className="card card-outline card-info">
                                        ...
                                        {datasList.length > 0 ?
                                            datasList.map((item, k) => (
                                                <tr key={k}>
                                                    ...
                                                    <td width={'170px'}>
                                                        <Link href={route('post.edit', item.id)} class="btn btn-info btn-xs mr-2">
                            ...
                            <div className="card-footer clearfix">
                                <Pagination links={postData.links} />
                            </div>
                        </div>
                    </div>
                </div>
